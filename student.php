...
<form  action="insertstudent.php" method="POST">
 ...
 <div class="form-group">
   ...
   <input type="text" name="department" class="form-control" id="formGroupExampleInput2" placeholder="BTECH, MTECH...">
 </div> 
 <div class="form-group">
   <label for="formGroupExampleInput2">Branch:</label>
   <input type="text" name="branch" class="form-control" id="formGroupExampleInput2" placeholder="CSE , IT...">
 </div> 
